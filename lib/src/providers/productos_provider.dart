...
class ProductosProvider {
  final String _url = 'https://flutter-test-d9a41.firebaseio.com';
  ...
  Future<List<ProductoModel>> cargarProductos() async {
    ...
    if (decodedData['error'] != null ) return [];//cuando hay error o el toekn vence
  ...
  Future<String> subirImagen(File imagen) async {
    final url = Uri.parse(
        'https://api.cloudinary.com/v1_1/dgxpwier0/image/upload?upload_preset=mqe8cjgj');
